...
export default function StorePage() {
  ...
  //cartProducts is an array of objects with two keys, one - product which contains the details of product and two - quantity. Visit cartSlice and detailsPage where it is shown how addToCard creates those two array of objects.
